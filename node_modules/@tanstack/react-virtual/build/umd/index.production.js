...
/**
   ...
   *
   * @license MIT
   */var E="undefined"!=typeof document?o.useLayoutEffect:o.useEffect;function O(e){var n=o.useReducer((function(){return{}}),{})[1],t=r({},e,{onChange:function(t){n(),null==e.onChange||e.onChange(t)}}),i=o.useState((function(){return new b(t)}))[0];return i.setOptions(t),o.useEffect((function(){return i._didMount()}),[]),E((function(){return i._willUpdate()})),i}e.Virtualizer=b,e.approxEqual=a,e.defaultKeyExtractor=u,e.defaultRangeExtractor=c,e.elementScroll=p,e.measureElement=g,e.memo=s,e.notUndefined=l,e.observeElementOffset=h,e.observeElementRect=f,e.observeWindowOffset=m,e.observeWindowRect=d,e.useVirtualizer=function(e){return O(r({observeElementRect:f,observeElementOffset:h,scrollToFn:p},e))},e.useWindowVirtualizer=function(e){return O(r({getScrollElement:function(){return"undefined"!=typeof document?window:null},observeElementRect:d,observeElementOffset:m,scrollToFn:v,initialOffset:"undefined"!=typeof document?window.scrollY:void 0},e))},e.windowScroll=v,Object.defineProperty(e,"__esModule",{value:!0})}));
