...
function Plansloactions() {
  ...
  let tableColumns = ['Plan Name', 'Validity', 'Description', 'Price'];

  if (activeTab === 'General Vouchers') {
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <Link to="https://portal2.bsnl.in/myportal/quickrecharge.do">
                          <button className="denominbtns btn">{item.denomination}</button>
                        </Link>
                      </td>
                    </tr>
                  ))}
